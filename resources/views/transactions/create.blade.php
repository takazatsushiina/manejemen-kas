            ...
            <form action="{{ route('transactions.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3" x-data="{ type: '{{ old('type', 'masuk') }}' }">
                            <label 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="amount" name="amount" class="form-input pl-12 text-right font-semibold text-lg" 
                               value="{{ old('amount') }}" min="0" step="1000" required placeholder="0">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" class="form-input resize-none" 
                              placeholder="Keterangan transaksi...">{{ old('description') }}</textarea>
                </div>
