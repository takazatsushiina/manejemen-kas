    ...
    <div class="max-w-xl mx-auto">
        <div class="card">
            ...
            <div class="card-body space-y-6">
                ...
                <div class="p-4 bg-sky-50 border border-sky-200 rounded-xl">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-sky-700">Rp {{ number_format($cashBookBalance, 0, ',', '.') }}
                            </p>
                ...
                <form action="{{ route('reconciliations.store') }}" method="POST" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="bank_balance" name="bank_balance" class="form-input pl-12"
                                value="{{ old('bank_balance') }}" step="0.01" required
                    ...
                    <div class="flex items-center gap-3 pt-4 border-t border-slate-100">
                        ...
                        <a href="{{ route('reconciliations.index') }}" class="btn-secondary">
