    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="stat-card text-center">
            ...
            <p class="text-3xl font-bold text-slate-800">Rp
                <?php echo e(number_format($pettyCash->current_balance ?? 0, 0, ',', '.')); ?></p>
            <?php if($pettyCash): ?>
                <p class="text-xs text-slate-400 mt-2">Terakhir update: <?php echo e($pettyCash->updated_at->diffForHumans()); ?></p>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('petty-cash.topup')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('petty-cash.withdraw')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="withdraw_amount" name="amount" class="form-input pl-12" min="1000"
                                max="<?php echo e($pettyCash->current_balance ?? 0); ?>" step="1000" required placeholder="0">
                        </div>
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\manajemen_kas\resources\views/petty-cash/index.blade.php ENDPATH**/ ?>