...
<body
    ...
    <div class="w-full max-w-md relative z-10">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" class="form-input pl-12"
        ...
        <p class="text-center mt-6 text-slate-400 text-sm">
            © <?php echo e(date('Y')); ?> SIMKAS. All rights reserved.
        </p>
    </div>
</body>

</html><?php /**PATH C:\xampp\htdocs\manajemen_kas\resources\views/auth/login.blade.php ENDPATH**/ ?>